...
contract WorkerPool
{
    ...
    function findWorker(uint256 _requiredComputingPower, uint256 exceptWorkerId) private view returns (uint256 workerId) 
    {
    ...
    function assignTask(uint256 _requiredComputingPower, uint256 taskId, uint256 exceptWorkerId) public returns (uint256) 
    {
        uint256 workerId = findWorker(_requiredComputingPower, exceptWorkerId);
